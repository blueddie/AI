...
from keras.layers import Dense, Conv2D, Flatten, Dropout, GlobalAveragePooling2D, Input, MaxPooling2D
...
conv1 = Conv2D(19, kernel_size=(4,4), activation='swish')(i1)      
conv2 = Conv2D(97, (4, 4),activation='swish')(conv1)
conv3 = Conv2D(210, (3,3), activation= 'swish')(conv2)
max1 = MaxPooling2D()(conv3)
flat1 = Flatten()(max1)
d1 = Dense(124, activation='swish')(flat1)
drop1 = Dropout(0.3)(d1)
d2 = Dense(48, activation='swish')(drop1)
o1 = Dense(100,activation='softmax')(d2)
