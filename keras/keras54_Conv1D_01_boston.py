...
from keras.layers import Dense, Conv2D, Dropout, Flatten, SimpleRNN, LSTM, Flatten , Conv1D
...
#2
model = Sequential()
model.add(Conv1D(filters=16, kernel_size=2 ,activation='relu',input_shape=(13,1)))
model.add(Flatten())
...
# Conv1D
# R2 score :  0.7365525209102731
# loss :  3.003584384918213
