...
es = EarlyStopping(monitor='val_accuracy', mode='max', patience=200, verbose=1, restore_best_weights=True)
...
hist = model.fit(X_train, y_train, epochs=50000, batch_size=500, validation_split=0.2, callbacks=[es, mcp])
