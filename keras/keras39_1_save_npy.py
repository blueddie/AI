...
np.save(np_path + 'keras39_1_x_train_np.npy', arr=Xy_train[0][0])
np.save(np_path + 'keras39_1_y_train_np.npy', arr=Xy_train[0][1])
np.save(np_path + 'keras39_1_x_test_np.npy', arr=Xy_test[0][0])
np.save(np_path + 'keras39_1_y_test_np.npy', arr=Xy_test[0][1])
